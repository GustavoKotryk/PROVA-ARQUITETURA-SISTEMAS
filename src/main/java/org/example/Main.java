        ...
        while (opcao == 0) {
            ...
            switch (opcao) {
                case 1: /GERENCIAR FUNCIONÁRIOS (Viola SRP)
                    System.out.println("1-Listar / 2-Contratar /
                            3 - Demitir / 4 - Editar");
                ...
                case 2: /PAGAMENTOS E AUMENTO(Viola SRP e OCP)
                    ...
                    System.out.print("Porcentagem de aumento (ex: 10):
                            ...
                            funcSalarios[Cod] += funcSalarios[Cod] *
                                    (aumento / 100);
                    System.out.println("Novo salário de " +
                            funcNomes[Cod] + ": R$ " + funcSalarios[Cod]);
                    break;
                case 3: /CARDÁPIO(Viola SRP)
                    for (int i = 0; i < pratoTotal; i +)
                        System.out.println(i
                                + ": " + pratoNomes[i] + " - R$ " + pratoPrecos[i]);
                    System.out.println("Deseja cadastrar novo?
                    (1 - Sim / 0 - Não) ");
                ...
                case 5: /VENDA COMPLEXA (Viola SRP, OCP, LSP, ISP, DIP)
                    ...
                    if (tipoVenda = 2) valorBase += 15.0; /Frete Fixo
                    (Fere OCP)
                    System.out.println("Pagamento: 1-Crédito / 2-Débito /
                            3 - PIX / 4 - Espécie");
...
/Funcionários Iniciais
        funcNomes[0] = "Lucas (Dono)";
        funcCargos[0] = "Gerente";
        funcSalarios[0] = 8000;
        funcNomes[1] = "Ana";
        funcCargos[1] = "Caixa";
        funcSalarios[1] =
                2000;
        funcNomes[2] = "Beto";
        funcCargos[2] = "Cozinheiro";
        funcSalarios[2] = 3000;
        funcNomes[3] = "Zeca";
        funcCargos[3] = "Cozinheiro";
        funcSalarios[3] = 3000;
        funcNomes[4] = "Vitor";
        funcCargos[4] = "Garçom";
        funcSalarios[4]
        ...
        funcSalarios[5]
                = 1800;
        funcNomes[6] = "Dona Flor";
        funcCargos[6] = "Limpeza";
        funcSalarios[6] = 1600;
        funcNomes[7] = "Marcio";
        funcCargos[7] = "Segurança";
        funcSalarios[7] = 2500;
        funcNomes[8] = "Tiago";
        funcCargos[8] = "Motoboy";
        funcSalarios[8] = 2200;
        funcTotal = 9;
/Pratos Brasileiros
        ...
        pratoPrecos[4] = 80.0;
        pratoEstoque[4] = 3;
        pratoNomes[5] = "Vaca Atolada";
        pratoPrecos[5] = 40.0;
        pratoEstoque[5] = 7;
        pratoNomes[6] = "Arroz Carreteiro";
        pratoPrecos[6] = 30.0;
        pratoEstoque[6] = 12;
        pratoNomes[7] = "Pão de Queijo Porção";
        pratoPrecos[7] = 15.0;
        pratoEstoque[7] = 20;
        pratoNomes[8] = "Barreado";
        pratoPrecos[8] = 50.0;
        pratoEstoque[8] = 6;
        pratoNomes[9] = "Tacacá";
        pratoPrecos[9] = 28.0;
